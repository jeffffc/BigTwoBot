...
namespace BigTwoBotNode
{
    public static class Helpers
    {
        ...
        public static InlineKeyboardMarkup GenerateStartMe(string lang)
        {
        ...
        public static InlineKeyboardMarkup GenerateStartMe(long id)
        {
            return GenerateStartMe(GetLanguage(id));
        }
